    ...
    },
    {
      ...
      renderCell: ({ row }) => (
        <Stack direction="row" spacing={1}>
          <EditButton hideText recordItemId={row.id} resource="tags" />
          <DeleteButton hideText recordItemId={row.id} resource="tags" />
        </Stack>
      ),
    },
  ];
      ...
      <PageHeader
        ...
        rightSlot={
          <Stack direction="row" spacing={2}>
            ...
            <Button variant="contained" onClick={() => go({ to: "/blog/tags/create" })}>
              新建标签
            </Button>
          </Stack>
        }
